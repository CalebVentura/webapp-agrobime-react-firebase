...
const TeamComponent = () => {
    return (
        <div className="TeamComponent" id={"Team"}>
                ...
                {data.team.map((item, index) =>
                    <Col xs={18} sm={18} md={4} other={4} className={"team-item RQ-my-3"}>
                        <div className="team-item-content RQ-text-center">
                            ...
                            <h3 className={"RQ-f-u16-o18 RQ-mt-2 RQ-mb-0 RQ-hover-text-theme3"}>{item.name}</h3>
                            <p className={"RQ-f-u14-o16 RQ-hover-text-theme3"}>{item.career}</p>
                        </div>
                    </Col>
                )}
            </Row>
